...
namespace Reflection.Models {
    public class ComparisonCore {
        ...
        public CompareTable Execute(IWorkTable masterTable, IWorkTable testTable) {
            ...
            Comparator = new Comparator(ComparisonTask.ComparisonKeys);
            //group
            PerfCounter.Start();
        ...
        private int FindInsType() {
            Dictionary<int, string> columnNames = new Dictionary<int, string>();
            for (int i = 0; i < MasterTable.Headers.Data.Length; i++) {
                columnNames.Add(i, MasterTable.Headers.Data[i]);
            }
